...
class Editor extends Component {
  ...
  render() {
    ...
    let params
    if (id !== undefined) {
      params = `merchantCode=${merchantCode}&id=${id}&createBy=${employeeId}&lttType=${type}&loginName=${loginName}`
    } else if (activityId !== undefined){
      params = `merchantCode=${merchantCode}&createBy=${employeeId}&lttType=${type}&loginName=${loginName}&activityId=${activityId}`
    } else {
      params = `merchantCode=${merchantCode}&createBy=${employeeId}&lttType=${type}&loginName=${loginName}`
    }
    console.log(params)
    return (
